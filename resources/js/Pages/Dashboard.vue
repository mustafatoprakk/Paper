...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="pt-10 bg-gradient-to-r from-sky-100 to-indigo-100">
            <div class="p-16">
                <div
                    class="bg-blue-200 py-52 shadow-sm hover:shadow-2xl duration-700 max-w-lg px-4  mx-auto text-left md:max-w-none md:text-center rounded-xl">
                    <h1
            ...
            <div class="p-16">
                <h1
                    class="text-3xl mb-6 font-semibold text-center text-gray-600 capitalize lg:text-5xl dark:text-slate-600">
                    Galeri
                </h1>
                <div v-if="posts.data.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
                    <div v-for="post in posts.data" :key="post.id">
                        <div class="relative">
                            <img class="h-auto max-w-full rounded-lg hover:shadow-2xl hover:border-1 duration-300"
            ...
            <div class="p-16">
                ...
                <h1
                    class="text-3xl mb-6 font-semibold text-center text-gray-700 capitalize lg:text-5xl dark:text-slate-700">
                    What we are doing
                </h1>

                <section class="bg-slate-400 dark:bg-slate-300 shadow-xl rounded-xl">
                    <div class="container px-6 py-10 mx-auto">
                        <div class="grid grid-cols-1 gap-8 mt-8 xl:my-5 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
