...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-16 mt-10 px-60">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div
                    class="w-full max-w-sm bg-white hover:border-2 border border-gray-200 rounded-lg hover:shadow-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="pb-8 rounded-t-lg" src="/images/products/product1.jpg" alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <a href="#">
