...
<template>
    <footer class="bg-white dark:bg-zinc-200">
        <div class="container flex flex-col items-center justify-between px-6 py-8 mx-auto lg:flex-row">
            ...
            <div class="flex flex-wrap items-center justify-center gap-4 mt-6 lg:gap-6 lg:mt-0">
                <a href="#"
                    class="text-sm text-gray-600 transition-colors duration-300 dark:text-gray-600 hover:text-blue-500 dark:hover:text-blue-400">
                    Overview
                </a>
